/**
 * @file wavenet_layer_array.hpp
 * @brief WaveNet layer array (dilated convolution stack) for NAM models
 *
 * From GuitarML/Mercury's wavenet implementation.
 * Original: https://github.com/GuitarML/Mercury/blob/main/wavenet/wavenet_layer_array.hpp
 * License: MIT
 */
#pragma once
