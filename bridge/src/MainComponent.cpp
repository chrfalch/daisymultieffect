    ...
    bridge_->onMidiRouted = [this](const juce::MidiMessage& msg, 
        ...
        if (msg.isSysEx())
        {
            ...
            if (size >= 2 && data[0] == 0x7D)
            {
                ...
                switch (data[1])
                {
                    case 0x10: cmdName = "SET_PATCH"; break;
                    case 0x11: cmdName = "PATCH_DUMP"; break;
                    case 0x12: cmdName = "GET_PATCH"; break;
                    case 0x30: cmdName = "GET_EFFECT_META"; break;
                    case 0x31: cmdName = "EFFECT_META_RESP"; break;
                    case 0x32: cmdName = "GET_ALL_META"; break;
                    case 0x40: cmdName = "BUTTON_STATE"; break;
                    case 0x41: cmdName = "TEMPO_UPDATE"; break;
                    default: cmdName = "CMD_0x" + juce::String::toHexString(data[1]); break;
                }
